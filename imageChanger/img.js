let imgContainer = document.querySelector('.imgContainer-2');
let textContainer = document.querySelector('.textContainer-2');
let progress = document.querySelectorAll('.line-2');
let text = [
